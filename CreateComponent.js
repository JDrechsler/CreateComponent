...
var scriptCall = args[2]; /*?*/
var componentName = args[3]; /*?*/
var regCheckCompName = /^[a-zA-Z]+$/g;
var regCheckScriptCall = /^cc$/g;
if (scriptCall.match(regCheckScriptCall) /*?*/) {
    console.log("Scriptaufruf korrekt.");
...
function createComponent(compName) {
    var componentLocation = __dirname + "/" + componentName; /*?*/
